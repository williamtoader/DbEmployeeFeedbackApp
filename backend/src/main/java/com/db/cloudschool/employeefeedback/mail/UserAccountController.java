...
public class UserAccountController {
    ...
    // Once the user browses or visits the application,
    ...
    // Once the user fills the registration form and clicks on the submit
    // button this method gets triggered or executed.
    ...
    // Once the user clicks on the link which they received on their email,
    // confirmUserAccount() method will be executed, it will
    // validate the token is not empty (it should be present in the database),
    // otherwise user will redirect to the error.html with the message
    // “The link is invalid or broken”.
    // if the token is successfully validated then it will redirect
    // to the accountVerified view (accountVerified.html)
